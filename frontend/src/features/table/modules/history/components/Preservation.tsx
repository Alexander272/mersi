...
import { useGetPreservationsQuery } from '../../preservation/preservationApiSlice'
...
export const Preservation: FC<Props> = ({ instrumentId }) => {
	...
	return (
		<Table>
			<TableHead>
				<TableRow height={40}>
					<TableCell width={300}>Консервация / Расконсервация</TableCell>
