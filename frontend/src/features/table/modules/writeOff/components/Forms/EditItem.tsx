...
import { useDeleteWriteOffMutation, useUpdateWriteOffMutation } from '../../writeOffApiSlice'
...
export const EditWriteOffItem: FC<Props> = ({ data }) => {
	...
	const [update, { isLoading }] = useUpdateWriteOffMutation()
	const [remove, { isLoading: isDeleting }] = useDeleteWriteOffMutation()
			...
			<Stack component={'form'} onSubmit={submitHandler}>
				...
				<Stack direction={'row'} justifyContent={'center'} spacing={2}>
					...
					<Confirm
						...
						confirmText='Вы действительно хотите удалить запись о списании?'
						buttonComponent={
